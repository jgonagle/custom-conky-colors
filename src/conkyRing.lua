...
-------------------------------------------------------------------------------
--                                                                         MAIN
function conky_main(color, theme, n_cpu)
	...
	local clock_x_offset = 75
	local clock_y_offset = 482
--------------------------------------------------------------------------------
--                                                                         clock
	settings = {-- HOURS
		value=tonumber(conky_parse("${time %H}")),
		value_max=12             ,
		x=clock_x_offset         , y=clock_y_offset            ,
		graph_radius=48          ,
		graph_thickness=3        ,
		...
		txt_fg_colour=0xFFAC0B   , txt_fg_alpha=fga            ,
